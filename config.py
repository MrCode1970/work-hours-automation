...
def load_config() -> dict:
    ...
    """
    return {
        "SITE_USERNAME": get_env("SITE_USERNAME", "322062415"),
        "SITE_PASSWORD": get_env("SITE_PASSWORD", "1105"),
        "GSHEET_ID": get_env("GSHEET_ID", "1rlOdKX8ot0wDCT9BSyySnLkRc18KYbUm5cD_LllRUyU"),
